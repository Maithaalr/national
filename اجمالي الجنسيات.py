...
if uploaded_file:
    ...
    with tab5:
        ...
        excluded_institutions = [
            ...
            "كلية تقنيات العليا دبي", "جامعة زايد", "جامعة الإمارات العربية المتحدة" ,"جامعة الإمارات"
        ]
        ...
        st.markdown("### تحليل مفصل لنسب النقص في الحقول")
        ...
        for field in fields_to_check:
            ...
            st.markdown(f"**🔎 {field}:**")
            st.info(f"عدد القيم الناقصة: {null_count} من أصل {total} سجل ({null_percent}%)")
